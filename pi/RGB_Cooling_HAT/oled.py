...
while True:
    ...
    draw.text((x, top+8), str(MemUsage, encoding="utf-8"),  font=font, fill=255)
    draw.text((x, top+16), str(Disk, encoding="utf-8"),  font=font, fill=255)
    draw.text((x, top+24), "IP:" + str(IP, encoding="utf-8"),  font=font, fill=255)
